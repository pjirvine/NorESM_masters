...
out_name_append = 'r_Full-GLENS'
y_label = 'Full-GLENS anomaly (mmd$^{-1}$)'
cases = ['Full-GLENS','RCP8.5','Baseline']

# out_name_append = 'r_Half-GLENS'
# y_label_exp = 'Half-GLENS anomaly (mmd$^{-1}$)' # NOTE separate the units off
...
plt.savefig(out_dir+'fig_2_'+out_name_append+'.png', format='png', dpi=600)
plt.savefig(out_dir+'fig_2_'+out_name_append+'.eps', format='eps', dpi=600)
