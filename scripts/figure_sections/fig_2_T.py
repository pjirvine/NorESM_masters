...
# out_name = 'fig_2_Full-GLENS_T_Tmax'
# y_label = 'Full-GLENS anomaly ($^\circ$C)'
# cases = ['Full-GLENS','RCP8.5','Baseline']

out_name = 'fig_2_Half-GLENS_T_Tmax'
y_label = 'Half-GLENS anomaly ($^\circ$C)'
...
var_1_ticks = [-15.,-10.0,-5.0,0,5.0,10.0,15.0]
var_1_ticklabels = ['-15','-10','-5','0','5','10','15']

var_1_aspect = 30./100. # set so bottom panel has same aspect ratio as top

var_2_xlims = [-20,20]
var_2_xnum_steps = 5
var_2_bottom_step = 1

var_2_ticks = [-20.0,-10.0,0,10.0,20.0]
var_2_ticklabels = ['-20','-10','0','10','20']

var_2_aspect = 40./100. # set so bottom panel has same aspect ratio as top
...
plt.title('Max. Temperature (Tmax)')
...
plt.xlabel('RCP8.5 anomaly ($^\circ$C)')
...
rect = patches.Rectangle((left_begin,bot_begin),19,78,linewidth=1,edgecolor='k',facecolor='white',clip_on=False)
